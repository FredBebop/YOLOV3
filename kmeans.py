...
def get_kmeans(anno_result, cluster_num=9):

    anchors = kmeans(anno_result, cluster_num)
    ave_iou = avg_iou(anno_result, anchors)
...
if __name__ == '__main__':
    ...
    print(ave_iou)
    with open(os.path.join(os.path.abspath('.'),'data\\anchors\\anchors.txt'),'w') as f:
